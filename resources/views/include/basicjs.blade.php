    ...
    <script src="{{ asset('front_asset/js/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/modernizr.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/script.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/wow.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/slick.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/parallax.js') }}" type="text/javascript"></script>
    <script src="{{ asset('front_asset/js/select-chosen.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        function openEmployerLogin() {
          document.getElementById("employerlogin").style.display = "block";
        }
