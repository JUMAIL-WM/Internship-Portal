...
<div class="theme-layout" id="scrollup">
	...
	<div class="responsive-header">
		<div class="responsive-menubar">
			<div class="res-logo"><a href="{{route('home')}}" title=""><img src="/front_asset/images/resource/logo 7.png" alt="" /></a></div>
	...
	<header class="stick-top">
		<div class="menu-sec">
			<div class="container">
				<div class="logo">
					<a href="{{route('home')}}" title=""><img src="/front_asset/images/resource/logo 7.png" alt="" /></a>
				</div><!-- Logo -->
